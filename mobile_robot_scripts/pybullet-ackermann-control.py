...
startPos = [0,0,1]
startOrientation = p.getQuaternionFromEuler([0,0.785,0])

RENDER_HEIGHT = 720
RENDER_WIDTH = 960

objUid = p.loadURDF(os.path.join(os.path.dirname(__file__),"urdf/ackermann_xacro_output.urdf"), startPos, startOrientation)
