...
class Kuka:
  ...
  def __init__(self, urdfRootPath=pybullet_data.getDataPath(), timeStep=0.01, physicsClientId = 0):
    ...
    self.reset(physicsClientId)

  def reset(self,physicsClientId):
    objects = p.loadSDF(os.path.join(self.urdfRootPath, "kuka_iiwa/kuka_with_gripper2.sdf"),physicsClientId = physicsClientId)
    ...
    self.trayUid = p.loadURDF(os.path.join(self.urdfRootPath, "tray/tray.urdf"), [0.640000,
                              0.075000, -0.190000], [0.000000, 0.000000, 1.000000, 0.000000], physicsClientId = physicsClientId)
